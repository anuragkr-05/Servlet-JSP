...
/**
 * Servlet implementation class RequestParamApp
 */
@WebServlet(description = "Working with HttpServletRequest",
			urlPatterns = { "/requestparam" })
public class RequestParamApp extends HttpServlet {
	private static final long serialVersionUID = 1L;

	static {
		System.out.println("Loading:: RequestParamApp.class file loading...");
	}
	
	public RequestParamApp() {
		System.out.println("Instantiation :: RequestParamApp()...");
	}
